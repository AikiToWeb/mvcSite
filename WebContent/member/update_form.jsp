...
// 현재 로그인한 회원의 정보들을 추출하도록 MemberInfo형 인스턴스로 세션 내의 정보를 생성
...
<tr><th width="20%">아이디</th><td width="*"><%=memberInfo.getMi_id() %></td>
<tr><th width="20%">이름</th><td width="*"><%=memberInfo.getMi_name() %></td>
</tr>
<tr>
<th>성별</th><td><%=(memberInfo.getMi_gender().equals("m") ? "남자" : "여자") %></td>
<th>생년월일</th><td><%=memberInfo.getMi_birth() %>
</tr>
