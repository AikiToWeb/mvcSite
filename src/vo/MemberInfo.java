...
public class MemberInfo {	// 한 명의 회원 정보를 저장할 클래스
	private int mi_idx, mi_point;
	private String mi_id, mi_pw, mi_name, mi_gender, mi_birth, mi_phone, mi_email, mi_isad, mi_grade;
	private String mi_rebank, mi_reaccount, mi_recommend, mi_date, mi_isact, mi_lastlogin;
	...
	public String getMi_reaccount() {
		return mi_reaccount;
	}
	public void setMi_reaccount(String mi_reaccount) {
		this.mi_reaccount = mi_reaccount;
	}
